    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={{ flex: 1 }}>
        ...
        {__DEV__ && (
          <TouchableOpacity
            style={styles.navBtn}
            onPress={() => {
              navigation.navigate("UpdateTimeTables");
            }}
          >
            <Text style={styles.navBtnText}>Update time table</Text>
          </TouchableOpacity>
        )}
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            navigation.push("Detail", {
              ...
              url: "https://corkconnect.ie/app-terms-and-conditons/",
            });
          }}
        >
      ...
      <View style={{ flexDirection: "row", marginTop: 8 }}>
        <TouchableOpacity
          ...
          onPress={() => {
            Linking.openURL("https://www.facebook.com/CorkConnect2020/");
          }}
        >
          <FacebookIcon />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          style={{ marginRight: 16 }}
          onPress={() => {
            Linking.openURL("https://twitter.com/connect_cork");
          }}
        >
          <TwitterIcon />
        </TouchableOpacity>
